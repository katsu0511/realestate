...
/**
 * Servlet implementation class ShowAdditionalItemServlet
 */
@WebServlet("/show/additional_item")
public class ShowAdditionalItemServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowAdditionalItemServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session.getAttribute("userName") == null || session.getAttribute("password") == null) {
			...
			try {
				...
				ArrayList<String> adit = new ArrayList<String>();
			...
			if (data_exists) {
				request.getRequestDispatcher("/WEB-INF/app/show/show_additional_item.jsp").forward(request, response);
			} else {
