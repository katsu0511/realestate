...
<main>
	<div class="container">
		<h2>自社情報登録</h2>
		<form name="CMPN" action="${pageContext.request.contextPath}/register/company" method="POST">
			...
			<div class="tr">
				...
				<div class="td">
					<input type="text" id="cmpn_id" class="back-gray" name="cmpn_id" value="${cmpnid}" readonly>
				</div>
			</div>
			...
			<div class="tr">
				...
				<div class="td">
					<input type="text" id="cmpn_name" class="check_target" name="cmpn_name" value="${cmpn[0]}" required>
			...
			<div class="tr">
				...
				<div class="td">
					<input type="text" id="cmpn_kana" class="check_target" name="cmpn_kana" value="${cmpn[1]}" pattern="^([ァ-ンヴー|　| ]{1,})+$" required>
					<p>※カタカナ以外はエラーになります</p>
			...
			<div class="tr">
				...
				<div class="td">
					<input type="text" id="rpst_name" class="check_target" name="rpst_name" value="${cmpn[2]}" required>
			...
			<div class="tr">
				...
				<div class="td">
					<input type="text" id="brnc_name" class="check_target" name="brnc_name" value="${cmpn[3]}" required>
					<p id="brnc_name_error1" class="error">本支店名を入力してください</p>
				</div>
			</div>
			
			<div class="tr">
				<label for="user_name" class="th">ユーザー名:<span>*</span></label>
				<div class="td">
					<input type="text" id="user_name" class="check_target" name="user_name" value="${cmpn[4]}" maxlength="32" pattern="^([a-zA-Z0-9.?/_-]{6,32})$" oninput="value = value.replace(/[^0-9A-Za-z.?/_-]+/i,'');" autocomplete="off" required>
					<p>※半角英数字6文字以上</p>
					<p id="user_name_error1" class="error">ユーザー名を入力してください</p>
					<p id="user_name_error2" class="error">正しいユーザー名の形式で入力して下さい</p>
					<c:if test="${errorMessage != null && errorMessage != ''}">
						<p style="color:red;">このユーザー名はすでに登録されています</p>
					</c:if>
				</div>
			</div>
			...
			<div class="tr">
				...
				<div class="td">
					<input type="password" id="password" class="check_target" name="password" value="${cmpn[5]}" maxlength="32" pattern="(?=.*\d)(?=.*[a-z]).{8,32}" oninput="value = value.replace(/[^0-9A-Za-z.?/_-]+/i,'');" autocomplete="off" required>
					<p>※半角英数字8文字以上</p>
			...
			<div class="tr">
				...
				<div class="td">
					<input type="password" id="password2" class="check_target" name="password2" value="${cmpn[5]}" maxlength="32" pattern="(?=.*\d)(?=.*[a-z]).{8,32}" oninput="value = value.replace(/[^0-9A-Za-z.?/-_]+/i,'');" autocomplete="off" required>
			...
			<div class="tr">
				...
				<div class="td">
					<input type="text" id="zip1" class="zip check_target" name="zip1" value="${cmpn[6]}" maxlength="3" oninput="value = value.replace(/[^0-9]+/i,'');" pattern="[0-9]{3}" onkeyup="AjaxZip3.zip2addr('zip1', 'zip2', 'address1', 'address2');" required>
					-
					<input type="text" id="zip2" class="zip check_target" name="zip2" value="${cmpn[7]}" maxlength="4" oninput="value = value.replace(/[^0-9]+/i,'');" pattern="[0-9]{4}" onkeyup="AjaxZip3.zip2addr('zip1', 'zip2', 'address1', 'address2');" required>
					<p>(例：123-4567)</p>
...
$(function() {
	...
	submit.click(function() {
		...
		$('#password2_error3').css("display", "none");
		var has_error = false;
