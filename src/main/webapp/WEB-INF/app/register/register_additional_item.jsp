...
<main>
	<div class="container">
		<h2>追加項目登録</h2>
		<form name="ADIT" action="${pageContext.request.contextPath}/register/additional_item" method="POST">
			...
			<div class="tr">
				...
				<div class="td">
					<input type="text" id="adit_id" class="back-gray" name="adit_id" value="${aditid}" readonly>
				</div>
			</div>
			...
			<div class="tr">
				...
				<div class="td">
					<input type="text" id="item_name" class="check_target" name="item_name" value="${adit[0]}" required>
			...
			<div class="tr">
				...
				<div class="td">
					<input type="text" id="item_id" class="check_target" name="item_id" value="${adit[1]}" oninput="value = value.replace(/[^0-9A-Za-z_-]+/i,'');" required>
					<p>※半角で入力してください。</p>
			...
			<div class="tr">
				...
				<div class="td">
					<input type="text" id="max_lng" class="short" name="max_lng" value="${adit[2]}" maxlength="2" oninput="value = value.replace(/[^0-9]+/i,'');">
				</div>
			</div>
			...
			<div class="tr">
				...
				<div class="td">
					<input type="text" id="spc_lng" class="short" name="spc_lng" value="${adit[3]}" maxlength="100" oninput="value = value.replace(/[^0-9,]+/i,'');">
			...
			<div class="tr">
				...
				<div class="td">
					<textarea id="comment" name="comment">${adit[4]}</textarea>
				</div>
			</div>
